...
public class OrderTest {
	...
	public void testPriceWithTaxesWithoutRoundUp() {
		...
		// when
		Order order1 = getOrderWithCertainProductPrice(2); // 2 PLN
		Order order2 = getOrderWithCertainProductPrice(100);
		Order order3 = getOrderWithCertainProductPrice(40.65);
		Order order4 = getOrderWithCertainProductPrice(40.66);

		// then
		assertBigDecimalCompareValue(order1.getPriceWithTaxes(), BigDecimal.valueOf(2.46)); // 2.44 PLN
		assertBigDecimalCompareValue(order2.getPriceWithTaxes(), BigDecimal.valueOf(123)); // 123 PLN
		assertBigDecimalCompareValue(order3.getPriceWithTaxes(), BigDecimal.valueOf(50)); // 50 PLN
		assertBigDecimalCompareValue(order4.getPriceWithTaxes(), BigDecimal.valueOf(50.01)); // 50 PLN
	}
	...
	public void testPriceWithTaxesWithRoundDown() {
		...
		// when
		Order order1 = getOrderWithCertainProductPrice(0.01); // 0.01 PLN
		Order order2 = getOrderWithCertainProductPrice(60.27); // 0.01 PLN

		// then
		assertBigDecimalCompareValue(order1.getPriceWithTaxes(), BigDecimal.valueOf(0.01)); // 0.01 PLN
		assertBigDecimalCompareValue(order2.getPriceWithTaxes(), BigDecimal.valueOf(74.13)); // 0.01 PLN
	}
